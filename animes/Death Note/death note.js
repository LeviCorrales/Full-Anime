...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/death note.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/death note img img 5.png"
		...
		imagen1.src = "../../imagenes/death note img 9.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/death note img 3.webp"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1_2 = document.querySelector(".boton-descargar-1-2")
const botonDescargar1_3 = document.querySelector(".boton-descargar-1-3")
const botonDescargar1_4 = document.querySelector(".boton-descargar-1-4")
const botonDescargar2 = document.querySelector(".boton-descargar-2")
const botonDescargar2B = document.querySelector(".boton-descargar-2_2")
const botonDescargar2_2 = document.querySelector(".boton-descargar-2-2")


botonDescargar1.addEventListener("click", descargar1)
botonDescargar1_2.addEventListener("click", descargar1_2)
botonDescargar1_3.addEventListener("click", descargar1_3)
botonDescargar1_4.addEventListener("click", descargar1_4)
botonDescargar2.addEventListener("click", descargar2)
botonDescargar2B.addEventListener("click", descargar2B)
botonDescargar2_2.addEventListener("click", descargar2_2)



enlaceMediafire = document.querySelector(".link-1")
let mediafireEp1_7 = `https://www.mediafire.com/folder/fb5mzkykvnr2q/DNote_01-07`
let mediafireEp8_13 = `https://www.mediafire.com/folder/v9qfpspyfz8zp/DNote_08-13`
let mediafireEp14_19 = `https://www.mediafire.com/folder/62tcus0l8h825/DNote_14-19`
let mediafireEp20_25 = `https://www.mediafire.com/folder/av4f2k53aar4t/DNote_20-25`
let mediafireEp26_31 = `https://www.mediafire.com/folder/kjq2qs87ummlw/DNote_26-31`
let mediafireTodo = `https://app.mediafire.com/5zgt8wd17l676`
let mediafireEp32_37 = `https://www.mediafire.com/folder/nlr6k1qsxgw14/DNote_32-37`

function descargar1(){
	enlaceMediafire.setAttribute("href", mediafireEp1_7)
	enlaceMediafire.click()
}
function descargar1_2(){
	enlaceMediafire.setAttribute("href", mediafireEp8_13)
	enlaceMediafire.click()
}
function descargar1_3(){
	enlaceMediafire.setAttribute("href", mediafireEp14_19)
	enlaceMediafire.click()
}
function descargar1_4(){
	enlaceMediafire.setAttribute("href", mediafireEp20_25)
	enlaceMediafire.click()
}
function descargar2(){
	enlaceMediafire.setAttribute("href", mediafireEp26_31)
	enlaceMediafire.click()
}
function descargar2B(){
	enlaceMediafire.setAttribute("href", mediafireTodo)
	enlaceMediafire.click()
}
function descargar2_2(){
	enlaceMediafire.setAttribute("href", mediafireEp32_37)
	enlaceMediafire.click()
}
