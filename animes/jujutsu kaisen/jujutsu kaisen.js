...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/jujutsu kisen 2.jpg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/jujutsu kaisen img 7.jpg"
		...
		imagen2.src = "../../imagenes/jujutsu kaisen img 4.webp"
		contenedorImg.appendChild(imagen2)
...
const botonDescargarMovie1080 = document.querySelector(".boton-descargar-movie-1080")
...
botonDescargarMovie1080.addEventListener("click", descargarMovie1080)

enlaceMediafire = document.querySelector(".link-1")
enlaceMediafire2 = document.querySelector(".link-1-2")
let mediafire1 = `https://www.mediafire.com/folder/twpujtli9wb67/Jujutsu+Kaien+Temp+1+Espa%C3%83%C2%B1ol+Latino+HD`
let mediafire2 = `https://www.mediafire.com/folder/12jkmn0423h3l/JJK4i53n+T2+Sub+[W0rld4nime53npai]`
let mediafire2Lat = `jujutsu kaisen 2.html`
let mediafireMovie = `https://www.mediafire.com/file/j4b6bzq2ao6krdp/gHuFWSidSSDsmnJujutssncue2.rar/file`
let mediafireMovie1080 = `https://www.mediafire.com/file/478atphnesoonfm/gHuFWSidSSDsmnJujutssncue3.rar/file`

document.querySelector(".boton-descargar-2-lat").addEventListener("click", () =>{
	enlaceMediafire2.setAttribute("href", mediafire2Lat)
...
function descargarMovie1080(){
	enlaceMediafire.setAttribute("href", mediafireMovie1080)
	enlaceMediafire.click()
}
