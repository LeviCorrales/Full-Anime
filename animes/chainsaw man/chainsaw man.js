...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/chainsaw man img 3.jpeg"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/chainsaw man img 6.jpg"
		...
		imagen2.src = "../../imagenes/chainsaw man img 2.jpg"
		contenedorImg.appendChild(imagen2)
...
let mediafireTemp1_720p_L_Ligero = `https://www.mediafire.com/folder/06oaj5ygrgbvo`
let mediafireTemp1_720p_L_Pesado = `https://www.mediafire.com/folder/ho7em0orl5qx4`
let mediafireTemp1_1080p_DA = `https://drive.google.com/drive/folders/1-bvody7G5gSUzOD43xmdFM-u-y6CQ8e_`


function descargar1(){
	enlaceMediafire.setAttribute("href", mediafireTemp1_720p_L_Ligero)
	enlaceMediafire.click()
}
function descargar1_2(){
	enlaceMediafire.setAttribute("href", mediafireTemp1_720p_L_Pesado)
	enlaceMediafire.click()
}
function descargar1_3(){
	enlaceMediafire.setAttribute("href", mediafireTemp1_1080p_DA)
	enlaceMediafire.click()
}
