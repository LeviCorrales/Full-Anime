...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/dr stone img 5.webp"
...
function avanzar(){
	...
	if (adelanteA == true) {
		imagen2.src = "../../imagenes/dr stone img 2.jpeg"
		...
		imagen1.src = "../../imagenes/dr stone img 9.jpeg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/dr stone img 3.webp"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1_1080 = document.querySelector(".boton-descargar-1_2")
const botonDescargar2 = document.querySelector(".boton-descargar-2")
const botonDescargar2_1080 = document.querySelector(".boton-descargar-2_2")
const botonDescargarSP = document.querySelector(".boton-descargar-2-2")
const botonDescargarSP_1080 = document.querySelector(".boton-descargar-2-2_2")
const botonDescargar3 = document.querySelector(".boton-descargar-3")
const botonDescargar3_1080 = document.querySelector(".boton-descargar-3_2")


botonDescargar1.addEventListener("click", descargar1)
botonDescargar1_1080.addEventListener("click", descargar1_1080)
botonDescargar2.addEventListener("click", descargar2)
botonDescargar2_1080.addEventListener("click", descargar2_1080)
botonDescargarSP.addEventListener("click", descargarSP)
botonDescargarSP_1080.addEventListener("click", descargarSP_1080)
botonDescargar3.addEventListener("click", descargar3)
botonDescargar3_1080.addEventListener("click", descargar3_1080)


enlaceMediafire = document.querySelector(".link-1")
let mediafire1 = `https://www.mediafire.com/folder/9jn5lnf7xdavq`
let mediafire1_1080 = `https://www.mediafire.com/folder/x8v5x5348zwuy`
let mediafire2 = `https://www.mediafire.com/folder/uxat3q96bwauy`
let mediafire2_1080 = `https://www.mediafire.com/folder/cmk0o6ghnkam9`
let mediafireSP = `https://www.mediafire.com/file/a7mmq6i68yhn9yr/%255BZ-A%255D_Special_LAT_HD.rar/file`
let mediafireSP_1080 = `https://www.mediafire.com/file/ofyo2ttn0ayqivp/%255BZ-A%255D_Special_LAT_FHD.rar/file`
let mediafire3 = `https://www.mediafire.com/folder/xifg374920n5r`
let mediafire3_1080 = `https://www.mediafire.com/folder/3dvv70y9dkif7`
...
function descargar2_1080(){
	enlaceMediafire.setAttribute("href", mediafire2_1080)
	enlaceMediafire.click()
}
function descargarSP(){
	enlaceMediafire.setAttribute("href", mediafireSP)
	enlaceMediafire.click()
}
function descargarSP_1080(){
	enlaceMediafire.setAttribute("href", mediafireSP_1080)
	enlaceMediafire.click()
}
function descargar3(){
