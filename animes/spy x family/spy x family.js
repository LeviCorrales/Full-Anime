...
let adelanteD = false
	...
	if (adelanteA == true) {
	imagen1.src = "../../imagenes/spyxfamily.png"
...
function avanzar(){
	...
	if (adelanteA == true) {
		...
		imagen1.src = "../../imagenes/spy family img 8.jpg"
		contenedorImg.appendChild(imagen1)
		...
		imagen2.src = "../../imagenes/spy family img 18.jpg"
		contenedorImg.appendChild(imagen2)
...
const botonDescargar1_2B = document.querySelector(".boton-descargar-1-2_2")
...
botonDescargar1_2B.addEventListener("click", descargar1_2B)
...
let mediafire1 = `https://www.mediafire.com/folder/mz3kqku3jsql9`
let mediafire1_2 = `https://www.mediafire.com/folder/vf2x3uwf7qf1a`
let mediafire1_2_1080 = `https://www.mediafire.com/folder/32a2ejk6d32qk`
let mediafire2 = `spy x family 2.html`
...
function descargar1_2B(){
	enlaceMediafire.setAttribute("href", mediafire1_2_1080)
	enlaceMediafire.click()
}
function descargar2(){
	enlaceMediafire2.setAttribute("href", mediafire2)
